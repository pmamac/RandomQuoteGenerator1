...
document.getElementById("quotes").innerHTML = quotes[getRandomQuote].source;
document.getElementById("quotes").innerHTML = quotes[getRandomQuote].citation;
document.getElementById("quotes").innerHTML = quotes[getRandomQuote].year;
}
