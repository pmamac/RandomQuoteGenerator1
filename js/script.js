...
let QuoteArray = Math.floor(Math.random() * quotes.length);
 ...
 random_quote = quotes[getRandomQuote].quote;
random_source = quotes[getRandomQuote].source;
 random_citation = quotes[getRandomQuote].citation;
random_year = quotes[getRandomQuote].year;
}
