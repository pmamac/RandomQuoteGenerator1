  ...
  },
{
  ...
  author: `Jordan B. Peterson | 12 Rules: An Antidote to Chaos`,
  citation: `12 Rules for Life | An Antidote for Chaos`,
  year: 2018
},
{
...
//I borrowed a code in Kritika Pattalam Bharathkumar blog for this part of my project. Link to her blog: https://blog.kritikapattalam.com/build-a-random-quote-generator-using-javascript
document.getElementById("quotes").innerHTML = quotes[getRandomQuote].quote;
document.getElementById("author").innerHTML = quotes[getRandomQuote].source;
document.getElementById("citation").innerHTML = quotes[getRandomQuote].citation;
document.getElementById("year").innerHTML = quotes[getRandomQuote].year;
}
...
***/
function printQuote() {
  document.write(quotes[getRandomQuote]);
} 
printQuote();
